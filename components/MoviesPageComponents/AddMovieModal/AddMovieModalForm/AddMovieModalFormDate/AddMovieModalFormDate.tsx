  ...
  return (
    <>
      <input
        ...
        type={isDate}
        className={`w-full appearance-none bg-[right_1rem_center] bg-no-repeat text-white py-3 px-4 rounded-[0.3rem] focus:outline-none placeholder-white bg-[#11101A] border border-[#6C757D]`}
      />
