  ...
  return (
    <div className='flex flex-col gap-1'>
      <textarea
        ...
        className={`w-full h-[5.375rem] bg-[right_1rem_top_1rem] bg-no-repeat text-white py-3 pl-4 pr-14 rounded-[0.3rem] focus:outline-none placeholder-white bg-[#11101A] border border-[#6C757D]`}
      />
