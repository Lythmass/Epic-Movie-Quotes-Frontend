...
export default function RegistrationModal() {
  ...
  return (
    <div className='w-full h-full z-20 fixed flex justify-center items-center bg-frozen-bg backdrop-blur-sm'>
      <div className='w-full h-full lg:w-[35%] lg:h-[49rem]'>
        <div className='flex overflow-auto pt-20 pb-12 flex-col items-center justify-start gap-8 w-full h-full z-20 bg-modal-bg'>
